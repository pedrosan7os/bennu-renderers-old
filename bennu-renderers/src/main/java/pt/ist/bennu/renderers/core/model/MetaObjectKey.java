...
/**
 * The MetaObjectKey represents a meta object key, that is, an identifier that allows to identify a meta object through out
 * several requests. The identifier can be used in the interface to refer to the meta object and to create identifier unique to
 * that meta object.
 * 
 * @author cfgi
 */
