...
@Renderer(type = Collection.class, layout = "ajax-tabular", properties = {
		@RendererProperty(name = "groupLinks", value = "true"), @RendererProperty(name = "linkGroupSeparator", value = ", "),
		@RendererProperty(name = "renderCompliantTable", value = "true") })
	...
	public class AjaxTabularLayout extends CollectionTabularLayout {
		...
		public void applyStyle(HtmlComponent component) {
			...
			if (getHeaderClasses() != null) {
				String[] headerClasses = getHeaderClasses().split(",", -1);
