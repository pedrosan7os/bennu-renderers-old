...
/**
 * This renderer presents an html menu with one option for each possible enum value. Each option's label is searched in the bundle
 ...
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, type = Enum.class)
