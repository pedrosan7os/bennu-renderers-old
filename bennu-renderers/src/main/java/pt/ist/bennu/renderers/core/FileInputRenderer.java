...
/**
 * This renderer creates a file input field that allows the user to submit a file. The renderer will set the slot with an output
 ...
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, type = InputStream.class)
public class FileInputRenderer extends InputRenderer {
	...
	/**
	 * When this property is specified the renderer will set the given slot with the content type of the file. The slot must have
	 * the string type.
	 * 
	 * @property
	 */
	...
	/**
	 * When this property is specified the renderer will set the given slot with the name of the file as given by the user. The
	 * slot must have the string type.
	 * 
	 * @property
	 */
	...
	/**
	 * When this property is specified the renderer will set the given slot with the size of the file in bytes. The slot must be
	 * have the <code>long</code> type.
	 * 
	 * @property
	 */
	...
	/**
	 * JavaScript statement to call when <b>Change</b> event is triggered. This can be used, for example, to model a behavior such
	 * like having this <code><b>input</b></code> element only allowing the submit <code><b>button</b></code> to be enabled when a
