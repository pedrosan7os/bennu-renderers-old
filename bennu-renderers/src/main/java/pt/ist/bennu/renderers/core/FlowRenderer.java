...
/**
 * The <code>FlowRenderer</code> can show several slots with a special layout. The slot's label and value are show one after the
 * other.
 * 
 * <p>
 * Example: Name: Joanne Age: 52
 */
@Renderer(layout = "flow", type = Object.class, properties = { @RendererProperty(name = "labelTerminator", value = ":"),
		@RendererProperty(name = "labelStyle", value = "font-weight: bold;") })
