...
public abstract class RequestRewriter {
	...
	protected boolean isPrefixed(final StringBuilder source, final int indexOfTagOpen) {
		return indexOfTagOpen >= LENGTH_OF_HAS_CONTENT_PREFIX
				...
				|| indexOfTagOpen >= LENGTH_OF_HAS_CONTEXT_PREFIX_NO_CHECKSUM_PREFIX
				&& match(source, indexOfTagOpen - LENGTH_OF_HAS_CONTEXT_PREFIX_NO_CHECKSUM_PREFIX, indexOfTagOpen,
						HAS_CONTEXT_PREFIX_NO_CHECKSUM_PREFIX);
	}
