...
/**
 * This renderer provides a basic way of presenting slot's values without a special organization. Only slot's values are presented
 * and they can have a separator between them. In the following example an object representing a person is shown using this
 * renderer and a separator of <code>" - "</code>.
 * 
 * <p>
 ...
 * @author cfgi
 */
@Renderer(layout = "values", type = Object.class)
public class ValuesRenderer extends OutputRenderer {
	...
	/**
	 * This property allows you to indicate if each value should be presented inside a <code>span</code> or a <code>div</code>,
	 * that is, inline or as a block. By default the values are presented inline.
	 * 
	 * @property
	 */
	...
	/**
	 * The htm separator to be placed between each value. The separator will appera between any two elements and never at the
