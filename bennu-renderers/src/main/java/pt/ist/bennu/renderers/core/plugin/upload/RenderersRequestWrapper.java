...
/**
 * Renderers wrapper round the request. This wrapper allows all elements of the framework to use
 * {@link javax.servlet.ServletRequest#getParameter(java.lang.String)} and the like regardlessly of the request nature.
 * 
 * @author cfgi
 */
