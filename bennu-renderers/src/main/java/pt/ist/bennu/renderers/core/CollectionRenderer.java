...
/**
 * This renderer provides a way of presenting a collection in a table. The table will have as many rows as there are objects in
 * the collection beeing presented. The table will have as many columns as the slots defined in the given schema.
 * 
 * <p>
 ...
 */
@Renderers({
		@Renderer(layout = "tabular", type = java.util.Collection.class, properties = {
				@RendererProperty(name = "groupLinks", value = "true"),
				@RendererProperty(name = "linkGroupSeparator", value = ", ") }), @Renderer(type = java.util.Collection.class) })
public class CollectionRenderer extends OutputRenderer {
	...
	/**
	 * The classes to be used in the table columns. You can separate classes with commas. The value "class1" means that all
	 * columns will have the specified class. The value "class1,class2" means that columns will have "class1" or "class2" as their
	 * class depending of their position. The first column will have "class1", the second "class2", the third "class1", etc. The
	 * only way to specify a class for the first and last column is to give empty classes to all the middle columns. So if you
	 * have 3 columns, a value of "class1,,class2" would put "class1" in the first column and "class2" in the third and last
	 * column.
	 * 
	 * @property
	 */
	...
	/**
	 * The value of the class attribute of each cell in the table's header. There is repetition as in
	 * {@linkplain #setColumnClasses(String) columnClasses} or {@linkplain #setRowClasses(String) rowClasses}.
	 * 
	 * @property
	 */
	...
	/**
	 * With this property you can choose if you want to display headers or not in the table
	 * 
	 * @property
	 */
	 ...
	 * can use a repeating pattern for the classes. A value like "gray," could make each alternating row be shaded.
	 * 
	 * @property
	 */
	...
	/**
	 * This property allows you to specify a string to be included as a suffix of each cell in the table. The suffix value can
	 * have a repeating pattern as {@linkplain #setRowClasses(String) rowClasses}. This means that, for the example above, a
	 * suffix of <code>"years old"</code> would produce rows like:
	 * 
	 * <table border="1">
	 * <tr>
	 * <td>Name A</td>
	...
	/**
	 * The Counter property indicates the property that should be getted to receive a number that will be displayed in the setted
	 * format right after the label
	 * 
	 * @property
	 */
	...
	/**
	 * The link property indicates the page to were the control link will point. All params will be appended to this link.
	 * 
	 * @property
	 */
	...
	/**
	 * By default the link property will be mapped to the current module. You can override that with this property.
	 * 
	 * @property
	 */
	...
	/**
	 * The <code>param</code> property allows you to indicate will values of the object shown in a given row should be used to
	 * configure the link specified.
	 * 
	 * <p>
	...
	/**
	 * The resource key that will be used to find the link name, that is, the name that will appear in the table.
	 * 
	 * @property
	 */
	...
	/**
	 * If the module's default bundle is not to be used you can indicate the alternative bundle with this property.
	 * 
	 * @property
	 */
	...
	/**
	 * An alternative to the {@link #setKey(String, String) key} property is specifying the text to appear directly. Oviously this
	 * approach does not work well with internationalized interfaces.
	 * 
	 * @property
	 */
	...
	/**
	 * As the container make no guarantees about the order properties are set in the implementation we can't rely on the order
	 * links appear defined in the page. You can use this attribute to explicitly indicate the order link should appear. The value
	 * is not important and it's only used for an alfabethic comparison. Both the following examples indicate that the links
	 * should appear in the order: a, c, b.
	 * <p>
	 * Example 1:
	 * 
	 * <pre>
	...
	/**
	 * This property allows you to exclude a control link from appearing in the first line of the generated table.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the name of the property that will consulted to determine if the link should be visible or not. By default all
	 * links are visible.
	 * <p>
	...
	/**
	 * This property does the same work as visibleIf but does the opposite logic. If <code>true</code> then the link will not be
	 * shown.
	 * 
	 * @property
	 */
	...
	/**
	 * This property allows you to exclude a control link from appearing in the last line of the generated table.
	 * 
	 * @property
	 */
	...
	/**
	 * With this property you can set the criteria used to sort the collection beeing presented. The accepted syntax for the
	 * criteria can be seen in {@link RenderUtils#sortCollectionWithCriteria(Collection, String)}.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies if the control links ares grouped in a single cell of the table. The linkGroupSeparator will be used to separate
	 * the control links.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates that the control links should be generated in their own row. This forces the links to be grouped and the
	 * {@link #setLinkGroupSeparator(String) link group separator} to be used so you should define that.
	 * 
	 * @property
	 */
	...
	/**
	 * This property indicates that each element wil be checkable. This means that a check box will be generated in each row
	 * allowing to select that row. The user will be responsible for wrapping the whole table in a form and submiting the form.
	 * 
	 * @property
	 */
	...
	/**
	 * The check box value is in fact a property of the object beeing displayed in the row. This is usefull, for example, to have
	 * as value an identificer of the object.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates that a link to select all checkboxes should be included in the presentation. This property is only valid when the
	...
	/**
	 * Chooses where the link should be placed. You can indicate the locations as text and the options are <code>top</code>,
	 * <code>bottom</code>, or <code>both</code>.
	 * 
	 * <p>
	 * Example: <br/>
	...
	/**
	 * The linkFormat property indicates the format of the control link. The params should be inserted in format. When this
	 * property is set, the link and param properties are ignored
	 * 
	 * <p>
	 * Example 1:
	 * 
	...
	/**
	 * If this property is specified all the others are ignored. This property allows you to specify the exact content to show as
	 * a link. Then content will be parsed with the same rules that apply to {@link #setLinkFormat(String, String) linkFormat}.
	 * 
	 * @property
	 */
	...
	/**
	 * The contextRelative property indicates if the specified link is relative to the current context or is an external link
	 * (e.g. https://anotherserver.com/anotherScript)
	 * 
	 * @property
	 */
	...
	/**
	 * The hasContext property indicates if the specified link should use context information
	 * 
	 * @property
	 */
	...
	/**
	 * The confirmationTitleKey property indicates the key of the confirmation title to show
	 * 
	 * @property
	 */
	...
	/**
	 * The confirmationKey property indicates the key of the confirmation message to show
	 * 
	 * @property
	 */
	...
	/**
	 * The confirmationBundle property indicates the bundle for the confirmation key message to show
	 * 
	 * @property
	 */
	...
	/**
	 * The confirmationArgs property indicates the arguments for a link confirmation.
	 * 
	 * @property
	 */
	...
	/**
	 * The target property indicates the arguments for a link target. Using setBlankTarget will override this value.
	 * 
	 * @property
	 */
	...
	public class CollectionTabularLayout extends TabularLayout {
		...
		private boolean canApplyConditionalClasses(MetaObject metaObject, ColumnCss columnCss) {
			Boolean useIf =
					columnCss.getUseIf() != null
							&& (Boolean) RendererPropertyUtils.getProperty(metaObject.getObject(), columnCss.getUseIf(), false);
			Boolean useIfNot =
					columnCss.getUseIfNot() != null
							&& (Boolean) RendererPropertyUtils
									.getProperty(metaObject.getObject(), columnCss.getUseIfNot(), false);
			return useIf || !useIfNot;
		}

		/**
		 * As the renderer uses the first object as a reference to build the header and fecth the information from all the objects
		 * in the collection we can have troubles when the collection contains objects of different types.
		 * 
		 * In this case we can't assume that all objects have the same slots (because of an unspecified schema). So we have to
		 * search slots by name and hope that it makes sense in the table.
		 */
			...
			if (getCustom() != null) {
				...
				final HtmlLink link =
						getHasContext() ? new HtmlLinkWithPreprendedComment(
								pt.ist.bennu.renderers.filters.RequestRewriter.HAS_CONTEXT_PREFIX) : new HtmlLink();
