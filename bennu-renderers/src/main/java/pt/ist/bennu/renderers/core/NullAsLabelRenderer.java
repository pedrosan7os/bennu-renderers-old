...
/**
 * This renderer protects the presentation of the <code>null</code> value. If you need to present the values of some slots but the
 * holder object is null you can use this renderer to present a message instead. This render can also be used to done the
 * unexistance of some value. Instead of having a blank presentation you can change the presentation of the value of a slot into a
 ...
 * @author cfgi
 */
@Renderer(layout = "null-as-label", type = Object.class, properties = { @RendererProperty(name = "label", value = "-") })
