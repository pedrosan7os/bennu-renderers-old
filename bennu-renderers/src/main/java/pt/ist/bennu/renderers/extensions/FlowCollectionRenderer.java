...
/**
 * This renderer allows you to present a collection of objects using a flow layout, that is, every object is presented just after
 * the previous without any special interface organization.
 * 
 * <p>
 ...
 * @author naat
 */
@Renderer(layout = "flowLayout", type = Collection.class)
public class FlowCollectionRenderer extends OutputRenderer {
	...
	/**
	 * Allows to prevent identation of the generated markup. This is specially usefull when you need to prevent extra spaces
	 * between elements and the separator.
	 * 
	 * @property
	 */
	...
	/**
	 * If you specify this property then value given will be inserted between any two object's presentations. This, depending on
	 * the individual presentation of each object, can be used to force line breaks or just provide a visual separator.
	 * 
	 * @property
	 */
	...
	/**
	 * When the given collection is empty this key will be used to fecth an according message for the situation. The bundle used
	 * is the module's default bundle.
	 * 
	 * @property
	 */
	...
	/**
	 * This property can be used to costumize the css classes of the message shown when the given collection is empty.
	 * 
	 * @property
	 */
	...
	/**
	 * When <code>emptyMessageKey</code> is used to specify wich resource key will be used when the collection is empty, this
	 * property allows to specify wich bundle will be used to fetch the key.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates if the each object's presentation should be placed inside a <code>&lt;div&gt;</code> or a
	 * <code>&lt;span&gt;</code>.
	 * 
	 * @property
	 */
