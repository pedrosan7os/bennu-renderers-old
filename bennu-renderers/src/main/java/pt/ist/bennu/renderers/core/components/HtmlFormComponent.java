...
public abstract class HtmlFormComponent extends HtmlComponent implements Convertible, Controllable, SlotChanger, Validatable {
	...
	/**
	 * Sets the name of this form component. If the name does not obey the rules for component names then it may be transformed to
	 * become conformat. Thus {@link #getName()} may return a value that is not equal to the name given in this method.
	 * 
	 * @param name
	 *            the desired name
	 */
