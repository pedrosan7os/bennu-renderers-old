 ...
 * allows the user to incrementally add more values in different languages. The user can also remove some of the values already
 * introduced.
 * <p>
 ...
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, type = MultiLanguageString.class)
public class MultiLanguageStringInputRenderer extends InputRenderer {
	...
	protected class MultiLanguageStringInputLayout extends Layout {
		...
		public HtmlComponent createComponent(Object object, Class type) {
			...
			if (map != null) {
				List<Map.Entry<Integer, LanguageBean>> list = new ArrayList<>(map.entrySet());
			...
			if (map != null && map.size() == 2 && firstRemoveLink != null && secondRemoveLink != null) {
