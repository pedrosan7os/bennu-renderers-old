...
/**
 * This renderer is a generic renderer that can be used to display simple list or tree views. The usual way of using this renderer
 * includes the configuration of the presentation of each item and the indication of how to get the children of each item.
 * Additionaliy you can specify control link that target each item.
 * 
 * <p>
 ...
 */
@Renderer(layout = "tree", type = Collection.class, properties = {
		@RendererProperty(name = "imageFor(Section)", value = "/images/icon-section.gif"),
		@RendererProperty(name = "imageFor(Item)", value = "/images/icon-item.gif"),
		@RendererProperty(name = "imageFor(Forum)", value = "/images/icon-forum.gif"),
		@RendererProperty(name = "imageFor(Attachment)", value = "/images/icon-attachment.gif"),
		@RendererProperty(name = "imageFor(FunctionalityCall)", value = "/images/icon-institutional.gif") })
public class TreeRenderer extends OutputRenderer {
	...
	/**
	 * Chooses the id of the generated tree. This property is required when you want the tree to be draggable. When the tree is
	 * generated a javaScript object with this id is generated so you have to specify a valid javascript identifier.
	 * 
	 * <p>
	...
	/**
	 * Chooses the layout to be used to presente objects of the specified type. You can use the simple name of the type.
	 * 
	 * @property
	 */
	...
	/**
	 * Chooses the schema to be used when presenting objects of the specified type. You can use the simple name of the type.
	 * 
	 * @property
	 */
	...
	/**
	 * This property specifies the name of the method that should be used, by default, to obtain the list of children for each
	 * item. If this property is not specified then, by default, items are considered to be leaf items.
	 * 
	 * @property
	 */
	...
	/**
	 * This property specifies the name of the method that should be used to obtain the list of children for item that are objects
	 * of the specified type. You can use the simple name or the complete type name if there are naem conflicts.
	 * 
	 * @property
	 */
	...
	/**
	 * This property indicates two things. First it indicates that you want a draggable tree. Second it specifies the id of the
	 * form field were the tree structure will be saved when you invoke the <tt>saveTree()</tt> operation of the tree.
	 * 
	 * <p>
	...
	/**
	 * This property is similar to {@link #setFieldId(String) fieldId}, that is, is also specifies that you want a draggable tree.
	 * Nevertheless when you specify this propert instead of the {@link #setFieldId(String) fieldId} the tree is saved is
	 * asynchronous way to the server to the url indicated in this property.
	 * 
	...
	/**
	 * This property indicates if the <tt>saveUrl</tt> is relative to the current module. This property is <code>true</code> by
	 * default.
	 * 
	 * @property
	 */
	...
	/**
	 * When the tree is saved in an asynchronous way this property chooses the name of the parameter that will contain the tree
	 * structure.
	 * 
	 * @property
	 */
	...
	/**
	 * This property specifies the javascript function to be executed when the tree structure is saved correctly, that is,
	 * submited without protocol errors to the server. You can specify an anonymous function like
	 * <tt>function() { alert('complete'); }</tt>
	 * 
	 * @property
	 */
	...
	/**
	 * This property specifies the javascript function to be executed when the tree structure cannot be saved correctly, that is,
	 * some error is reported by the server. You can specify an anonymous function like <tt>function() { alert('failed'); }</tt>
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the default link text to be included near each item. The text will be passed through
	 * {@link RenderUtils#getFormattedProperties(String, Object)} with the object of the item. This way you can include references
	 * the object's properties in the text.
	 * 
	 * @property
	 */
	...
	/**
	 * This property is similar to the {@link #setLinks(String) links} property but the links defined with this property will be
	 * hidden when the tree is draggable. This property is usefull to specify links that simulate the same actions available by
	 * drag and drop.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the links that should appear near items corresponding to objects of the given type. The link text is replaced in
	 * the same way than {@link #setLinks(String)}.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the hidden links that should appear near items corresponding to objects of the given type. The link text is
	 * replaced in the same way than {@link #setHiddenLinks(String)}.
	 * 
	 * @property
	 */
	...
	/**
	 * Chooses the css classes to apply to the container surrounding the item's links. If this property is not set a default
	 * class, based on the tree id, is applied.
	 * 
	 * @property
	 */
	...
	/**
	 * Sets the path of the image that should be used as a icon of items correponding to objects of the given type. The path is
	 * context relative.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies if the renderer should include the default images when the tree is draggable.
	 * 
	 * @property
	 */
