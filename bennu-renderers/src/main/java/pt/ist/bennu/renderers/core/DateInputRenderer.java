...
/**
 * This renderer provides a simple way of doing the input of a date. The date is accepted from a text input field using a certain
 * format. The format beeing accepted is shown to the right.
 * 
 * <p>
...
public class DateInputRenderer extends TextFieldRenderer {
	...
	/**
	 * The format in which the date should be displayed. The format can have the form accepted by <a
