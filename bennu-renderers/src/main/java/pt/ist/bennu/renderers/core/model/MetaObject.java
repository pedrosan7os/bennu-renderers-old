...
/**
 * A MetaObject is an abstraction of a real domain object. If provides a serializable representation or view of a concrete object
 * that can be freely manipulated in the renderer's lifecycle. The MetaObject prevents changes from beeing made to the domain
 * object until the object is commited with {@link #commit()}.
 * 
 * @author cfgi
 */
public abstract class MetaObject implements Serializable {
	...
	/**
	 * Allows access to the concrete domain object that is beeing protected by this meta-object.
	 * 
	...
	/**
	 * Allows acces to the list of all slots. This list is not backed by the meta object so any changes to the list will not
	 * affect the meta object.
	 * 
	 ...
	 * that instance.
	 * 
	 * @return an instance of the InstanceCreator used to create a new object or null if the object should be created using the
	 *         default constructor
	 */
	...
	/**
	 * Since the MetaObject is an abstraction for the real object this method allows a subclass to delay any changes to the
	 * application domain until the very last fase of the renderers lifecycle.
	 * 
	 * <p>
