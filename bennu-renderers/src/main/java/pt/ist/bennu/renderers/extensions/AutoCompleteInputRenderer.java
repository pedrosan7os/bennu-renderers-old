...
/**
 * This renderer allows you to search for a domain object by providing a list of possible completions, for the text typed, using a
 ...
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, layout = "autoComplete", type = DomainObject.class, properties = {
		@RendererProperty(name = "autoCompleteItemsStyleClass", value = "autoCompleteItems"),
		@RendererProperty(name = "autoCompleteStyleClass", value = "autoComplete"),
		@RendererProperty(name = "minChars", value = "3"), @RendererProperty(name = "valueField", value = "externalId") })
public class AutoCompleteInputRenderer extends InputRenderer {
	...
	/**
	 * Enforces a given width to the auto complete list. If it's not setted then the width will be the same as the input text
	 * field.
	 * 
	...
	/**
	 * This property allows you to specify a slot that will hold the text that was present in the input field when it was
	 * submited.
	 * 
	 * <p>
	...
	/**
	 * This property allows you tho choose the name of the slot that will be used as the presentation of the object. If this
	 * proprty has the value <code>slotL</code> then the list of suggestions will be a list of values obtained by invoking
	...
	/**
	 * Allows you select the presentation format. If not set the value of the field given by {@link #setLabelField(String)
	 * labelField} is used. See {@link pt.ist.bennu.renderers.core.utils.RenderUtils#getFormattedProperties(String, Object)} to
	 * see the accepted format syntax.
	 * 
	 * @property
	 */
	...
	/**
	 * Limits the number of results that the servlet returns thus the number of suggestions given to the user.
	 * 
	 * @property
	 */
