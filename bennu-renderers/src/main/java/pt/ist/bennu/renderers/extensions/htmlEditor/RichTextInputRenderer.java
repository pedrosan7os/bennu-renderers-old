...
/**
 * Allows you to use the <a href="http://tinymce.moxiecode.com/">TinyMCE</a> Javascript HTML WYSIWYG editor.
 * 
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, layout = "rich-text", type = String.class, properties = { @RendererProperty(
		name = "safe",
		value = "true") })
public class RichTextInputRenderer extends InputRenderer {
	...
	/**
	 * Allows you to choose a configuration for the editor. The given name is used to fetch the properties from a file located in
	 * {@value TinyMceEditor#CONFIG_PATH} with the same name and ending in ".properties".
	 * 
	 * @property
	 */
	...
	/**
	 * If this property is set to <tt>true</tt> then the input will be filtered and any unsupported HTML will be removed or
	 * escaped to the corresponding entities.
	 * 
	 * @property
	 */
