...
public class RendererPropertyUtils {
	...
	public static void initCache() {
		propertyDescriptorsCache = new HashMap<>();
		propertyTypeCache = new HashMap<>();
	}
	 ...
	 * for properties like <code>a.b</code> if the <code>a</code> is a null value. This method allows you to choose if the value
	 * for <code>a</code> is created or if the method simply returns <code>null</code>. Any exception thrown by
	 * {@link PropertyUtils} is wrapped in a {@link RuntimeException}.
	 * 
	 * @param object
	 *            the target object
	 * @param name
	 ...
	 * choose if the value for <code>a</code> is created or if the method simply returns without setting the value. Any exception
	 * thrown by {@link PropertyUtils} is wrapped in a {@link RuntimeException}.
	 * 
	 */
