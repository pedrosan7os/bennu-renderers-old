...
@Renderer(layout = "prefixed", type = Object.class, properties = { @RendererProperty(name = "indented", value = "false") })
	...
	protected Layout getLayout(Object object, Class type) {
		return new Layout() {
			...
			public HtmlComponent createComponent(Object object, Class type) {
				...
				HtmlText text =
						new HtmlText(
								getPrefixBundle() != null ? RenderUtils.getResourceString(getPrefixBundle(), getPrefixKey()) : getPrefixKey(),
								getPrefixBundle() == null);
