...
/**
 * This renderer provides a tabular presentation for a collection that allows rows of the table to be sorted by clicking the table
 * headers. The behaviour of this renderer is very similar to the one of {@link pt.ist.bennu.renderers.core.CollectionRenderer}.
 * 
 * <p>
 * Example:
 * <table border="1">
 ...
 * @author cfgi
 */
@Renderer(type = Collection.class, layout = "tabular-sortable", properties = {
		@RendererProperty(name = "groupLinks", value = "true"), @RendererProperty(name = "linkGroupSeparator", value = ", ") })
public class OrderableCollectionRenderer extends CollectionRenderer {
	...
	/**
	 * If <code>true</code>, generate link as an action link. Must also set sort form id property value, that indicates which form
	 * to submit.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates the url used to sort collection. Must be setted if action link is not used.
	 * 
	 * @property
	 */
	...
	/**
	 * The classes to use in a header when the corresponding column is ordered in <strong>ascending</strong> mode. This property
	 * can be used to use a custom style that denotes an ascending ordering.
	 * 
	 * @property
	 */
	...
	/**
	 * The classes to use in a header when the corresponding column is ordered in <strong>descending</strong> mode. This property
	 * can be used to use a custom style that denotes an descending ordering.
	 * 
	 * @property
	 */
	...
	/**
	 * If this property is specified an image will be placed to the left of the header title. This image will be used when the
	 * header is clicked and the ordering is <strong>ascending</strong>.
	 * 
	 * @property
	 */
	...
	/**
	 * If this property is specified an image will be placed to the left of the header title. This image will be used when the
	 * header is clicked and the ordering is <strong>descending</strong>.
	 * 
	 * @property
	 */
	 ...
	 * {@link #setDescendingImage(String) descendingImage} is relative to the application context or not.
	 * 
	 * @property
	 */
	...
	/**
	 * Colon separated values of slot names. If this property is not specified then all slots are considered sortable. If this
	 * property is sent then only the slots indicated are sortable.
	 * <p>
	...
	protected Layout getLayout(Object object, Class type) {
		Collection sortedCollection =
				isSortIgnored() ? (Collection) object : RenderUtils.sortCollectionWithCriteria((Collection) object, getSortBy());
