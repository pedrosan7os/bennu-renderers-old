 ...
 * presented as a simple string. The string to be presented is determined by the logic in {@link MultiLanguageString#getContent()}
 * . Additionally you can override the language in which the content is to be displayed with the {@link #setLanguage(String)
 * language} property. In this case the content to be presented will be determined by
...
@Renderers({
		@Renderer(
				layout = "html",
				type = MultiLanguageString.class,
				properties = { @RendererProperty(name = "escaped", value = "false"),
						@RendererProperty(name = "languageShown", value = "false") }),
		@Renderer(layout = "short-html", type = MultiLanguageString.class, properties = {
				@RendererProperty(name = "escaped", value = "false"), @RendererProperty(name = "None", value = "None") }),
		@Renderer(type = MultiLanguageString.class, properties = { @RendererProperty(name = "languageShown", value = "false") }) })
public class MultiLanguageStringRenderer extends StringRenderer {
	...
	/**
	 * Allows you to choose if a span or a div will be generated around the multi language string. This can be usefull if the
	 * multi-language string contains much information or html code.
	 * 
	 * @property
	 */
	...
	/**
	 * Whenever a multi-language string is shown in a language that is not what the user requested an annotation is added to shown
	 * in wich language the text is in. This property allows you to override that behaviour.
	 * 
	 * @property
	 */
	...
	/**
	 * Choose the css class to apply to the annotation showing the value's language when it isn't in the requested language.
	 * 
	 * @property
	 */
	...
	/**
	 * Force the diplay of the language of the text even when showing text in the language requested by the user.
	 * 
	 * @property
	 */
