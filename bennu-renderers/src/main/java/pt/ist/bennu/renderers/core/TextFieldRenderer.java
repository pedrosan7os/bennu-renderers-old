...
/**
 * This renderer serves as a base for all input renderers that are based in a text input field.
 * 
 * @author cfgi
 */
public abstract class TextFieldRenderer extends InputRenderer {
	...
	/**
	 * Indicates that the field is to be disabled, that is, the user won't be able to change it's value and it wont be submited.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates that the field is read only. The user cannot change the field's value but the field is submited.
	 * 
	 * @property
	 */
	...
	/**
	 * When the value of the <code>formatText</code> is a key this property indicates the name of the bundle where the key will be
	 * looked for.
	 * 
	 * @property
	 */
	...
	/**
	 * Indicates the the value of the <code>formatText</code> property is a key and not the text itself.
	 * 
	 * @property
	 */
