...
public interface ExceptionHandler {
	/**
	 * This method wil lbe called by the {@link RenderersRequestProcessor} when an exception occurs during the processing of a
	 * viewstate. Those exceptions normally represent problems when converting values or when updating certain object in the
	 ...
	 * @param mapping
	 * @param input
	 *            an action forward that maps to the place were the viewstate was created
	 * @param e
