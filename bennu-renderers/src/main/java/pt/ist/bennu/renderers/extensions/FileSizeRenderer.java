...
@Renderer(layout = "fileSize", type = Number.class, properties = { @RendererProperty(name = "shortUnit", value = "true") })
public class FileSizeRenderer extends OutputRenderer {
	...
	/**
	 * Chooses if the file size unit will be displayed in short name or not, as in <em>b</em> VS <em>bytes</em>.
	 * 
	 * @property
	 */
