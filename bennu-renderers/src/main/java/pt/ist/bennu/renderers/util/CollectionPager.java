...
public class CollectionPager<T> {
	 ...
	 * 
	 * @param pageNumber
	 *            The number of page to be displayed. The page number of the first page is 1.
	 * @return A collection containing the elements indexed between positions: (pageNumber - 1) * maxElementsPerPage and
	 *         pageNumber * maxElementsPerPage when iterating the specified collection.
	 */
