...
@Renderer(mode = RenderMode.INPUT, type = Interval.class, properties = { @RendererProperty(
		name = "image",
...
public class IntervalAsDatesInputRenderer extends InputRenderer {
	...
	/*
	 * Takes the string representing the interval, and creates the corresponding interval. The format is as defined in
	 * IntervalController
	 */
	...
	/*
	 * Takes the start and end date, and puts the data in the hidden field, in the format {startMillis};{endMillis}
	 */
