...
/**
 * This renderer provides a more fashionable way of doing the input of a date than the plain DateInputRenderer. The date is
 * accepted from a text input field using a certain format, but there is an auxiliary javascript calendar that pops out on the
 * click of a small image butoon The format beeing accepted is shown to the right of the textfield and before the calendar trigger
 * button.
 * 
 * <p>
