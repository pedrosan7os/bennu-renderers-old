...
/**
 * The MetaObjectCollection provides a wrapper for several meta objects. It's purpose, besides behaving like a collection of
 * objects or better a list, is to coordinate the {@link #commit()} operation for all the meta objects contained in this
...
public class MetaObjectCollection extends MetaObject {
	...
	public List<MetaSlot> getSlots() {
		List<MetaSlot> slots = new ArrayList<>();
