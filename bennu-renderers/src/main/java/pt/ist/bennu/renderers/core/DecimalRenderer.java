...
/**
 * This renderer provides a generic presentation for a decimal number. The number is formatted according to the format property
 * 
 * @author naat
 * @author jdnf
 */
@Renderers({ @Renderer(layout = "decimal-format", type = Double.class),
		@Renderer(layout = "decimal-format", type = BigDecimal.class) })
