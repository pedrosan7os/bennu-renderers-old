...
/**
 * This renderer provides a simple way of editing objects. A table is used to organize the presentation. Each slot will have it's
 * corresponding row. Each row has three columns. In the left column the slot's label will be presented. In the middle column the
 * editor for the slot's value will be presented. In the rightmost column validation errors are presented.
 * 
 * <p>
 * Example:
 * <table border="1">
 ...
 */
@Renderers({
		@Renderer(mode = RenderMode.INPUT, layout = "tabular-style5", type = Object.class, properties = {
				@RendererProperty(name = "labelTerminator", value = ":"),
				@RendererProperty(name = "classes", value = "tstyle3 thlight thright mbottom05"),
				@RendererProperty(name = "columnClasses", value = ",,tdclear tderror1"),
				@RendererProperty(name = "helpNoJavascriptClasses", value = "nojavascript"),
				@RendererProperty(name = "helpClosedClasses", value = "chelp closed"),
				@RendererProperty(name = "helpOpenClasses", value = "chelp copen"),
				@RendererProperty(name = "helpTextClasses", value = "chelptext"),
				@RendererProperty(name = "helpImageIcon", value = "images/icon_help.gif") }),
		@Renderer(mode = RenderMode.INPUT, layout = "tabular", type = Object.class, properties = {
				@RendererProperty(name = "labelTerminator", value = ":"),
				@RendererProperty(name = "helpNoJavascriptClasses", value = "nojavascript"),
				@RendererProperty(name = "helpClosedClasses", value = "chelp closed"),
				@RendererProperty(name = "helpOpenClasses", value = "chelp copen"),
				@RendererProperty(name = "helpTextClasses", value = "chelptext"),
				@RendererProperty(name = "helpImageIcon", value = "images/icon_help.gif") }),
		@Renderer(mode = RenderMode.INPUT, type = Object.class, properties = {
				@RendererProperty(name = "labelTerminator", value = ":"),
				@RendererProperty(name = "helpNoJavascriptClasses", value = "nojavascript"),
				@RendererProperty(name = "helpClosedClasses", value = "chelp closed"),
				@RendererProperty(name = "helpOpenClasses", value = "chelp copen"),
...
public class StandardInputRenderer extends InputRenderer {
	...
	private boolean requiredMarkShown = ConfigurationManager.getBooleanProperty("requiredMarkShown", false);
	 ...
	 * more details. Remember that the first column contains labels, the second column slot's editors, and the third the validator
	 * messages.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows you to suppress the inclusion of the validator messages in the standard layout. This is specilly usefull if you want
	 * to show all messages in one place in the page.
	 * 
	 * @property
	 */
	...
	/**
	 * Chooses the suffix to be added to each label. If the label already contains that suffix then nothing will be added. See
			...
			case 1:
				...
				if (!slot.isReadOnly()) {
					...
					if (validatable != null) {
						...
						if (ConfigurationManager.getBooleanProperty("javascriptValidationEnabled", false) && !isHideValidators()) {
