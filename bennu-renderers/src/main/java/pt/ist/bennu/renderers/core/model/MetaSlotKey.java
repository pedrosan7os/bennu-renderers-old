...
/**
 * The MetaSlotKey represents an indentifier that allows to identify in a single meta slot of a meta object. The string
 * representation of this key can be obtained by invoking {@link #toString()} and used in the interface to generate identifiers
 * that are unique to a certain slot.
 * 
