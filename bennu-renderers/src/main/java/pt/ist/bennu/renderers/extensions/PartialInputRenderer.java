...
@Renderers({
		@Renderer(mode = RenderMode.INPUT, type = LocalDate.class, properties = {
				@RendererProperty(name = "year", value = "true"), @RendererProperty(name = "month", value = "true"),
				@RendererProperty(name = "day", value = "true") }),
		@Renderer(mode = RenderMode.INPUT, type = YearMonthDay.class, properties = {
				@RendererProperty(name = "year", value = "true"), @RendererProperty(name = "month", value = "true"),
				@RendererProperty(name = "day", value = "true") }),
		@Renderer(mode = RenderMode.INPUT, layout = "hour-minute", type = Partial.class, properties = {
				@RendererProperty(name = "hour", value = "true"), @RendererProperty(name = "minute", value = "true") }),
		@Renderer(mode = RenderMode.INPUT, type = TimeOfDay.class, properties = {
				@RendererProperty(name = "hour", value = "true"), @RendererProperty(name = "minute", value = "true"),
				@RendererProperty(name = "second", value = "true") }),
		@Renderer(mode = RenderMode.INPUT, layout = "year-month-day", type = Partial.class, properties = {
				@RendererProperty(name = "year", value = "true"), @RendererProperty(name = "month", value = "true"),
				@RendererProperty(name = "day", value = "true") }),
		@Renderer(mode = RenderMode.INPUT, layout = "year", type = Partial.class, properties = { @RendererProperty(
				name = "year",
				value = "true") }),
		@Renderer(mode = RenderMode.INPUT, layout = "year-month", type = Partial.class, properties = {
				@RendererProperty(name = "year", value = "true"), @RendererProperty(name = "month", value = "true") }) })
