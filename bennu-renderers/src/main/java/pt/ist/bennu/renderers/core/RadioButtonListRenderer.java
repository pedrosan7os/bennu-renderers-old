...
/**
 * This renderer can be used as the input for a list of objects. The list of objects the user can choose will be presented as an
 * html list were each list item will contain the presentation of the object and a radio button that allows to choose that
 ...
 */
@Renderer(mode = RenderMode.INPUT, type = Object.class, layout = "radio-select", properties = {
		@RendererProperty(name = "eachClasses", value = "dinline"),
		@RendererProperty(name = "style", value = "list-style: none; padding: 0; margin: 0;") })
public class RadioButtonListRenderer extends SelectionRenderer {
	...
	/**
	 * This property allows you to configure the class attribute for each object's presentation.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows yout to configure the style attribute for each object's presentation.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows you to specify the schema that should be used when presenting each individual object.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows the possible object list to be persisted between requests, meaning that the provider is invoked only once.
	 * 
	 * @property
	 */
