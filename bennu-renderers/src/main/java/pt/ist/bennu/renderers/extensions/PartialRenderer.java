...
@Renderers({
		@Renderer(
				layout = "year-partial",
				type = Partial.class,
				properties = { @RendererProperty(name = "format", value = "yyyy") }),
		@Renderer(layout = "month", type = Partial.class, properties = { @RendererProperty(name = "format", value = "MMM") }),
		@Renderer(type = Partial.class), @Renderer(type = AbstractPartial.class) })
