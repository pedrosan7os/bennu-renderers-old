...
/**
 * By default the value of <code>format</code> is used to show to the user how to write the date. The <code>formatText</code>
 * property allows you to override that default. This means that the value of the property will be shown instead.
 */
@Deprecated
@Renderer(mode = RenderMode.INPUT, layout = "multiple-format-hour-minute", type = TimeOfDay.class, properties = {
