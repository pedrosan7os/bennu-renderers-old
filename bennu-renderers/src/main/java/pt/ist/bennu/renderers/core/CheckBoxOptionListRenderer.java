 ...
 * html list were each list item will contain the presentation of the object and a checkbox that allows to choose that particular
 * object. When submiting, all the checked objects will be added to a list and that list will be the value passed to the slot.
 * 
 * <p>
 * Example:
 * <ul>
...
public class CheckBoxOptionListRenderer extends SelectionRenderer {
	...
	/**
	 * Makes the renderer add and option that selects and unselects all the remaining options.
	 * 
	 * @property
	 */
