...
/**
 * An javascript html editor for doing the input of html text. This renderer abstracts the javascript html editor available in
 * Fenix and binds it to the slot beeing edited.
 * 
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, layout = "htmlEditor", type = String.class)
public class HtmlEditorRenderer extends InputRenderer {
	...
	/**
	 * The number of columns of the fall back textarea, that is, the text area that is shown when the html editor is not supported
	 * by the browser.
	 * 
	 * @property
	 */
	 ...
	 * escaped to the corresponding entities. The idea is that a piece of code like
	 * 
	 * <pre>
