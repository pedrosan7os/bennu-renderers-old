...
import pt.ist.bennu.renderers.filters.RequestRewriter;

/**
 * This render is used to create a link out of an object. You choose the link format and some properties can be used to configure
 * the link. You can also specify the link indirectly by specifing a destination and then defining a destination with that name in
 ...
 * @author cfgi
 */
@Renderer(layout = "link", type = Object.class, properties = { @RendererProperty(name = "contextRelative", value = "true") })
public class ObjectLinkRenderer extends OutputRenderer {
	...
	/**
	 * This allows to specify a presentation format for each object. For more details about the format syntaxt check the {@see
	 * FormatRenderer}.
	 * 
	 * @property
	 */
	...
	/**
	 * This property allows you to specify if the link opens in a new window or not. Defaults to false.
	 * 
	 * @property
	 */
	...
	/**
	 * This property allows you to specify the format of the final link. In this format you can use properties of the object being
	...
	/**
	 * Indicates that the link specified should be relative to the context of the application and not to the current module. This
	 * also overrides the module if a destination is specified.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows you to choose if the generated link is relative to the current module. Note that if the link is not context relative
	 * then it also isn't module relative.
	 * 
	 * @property
	 */
	...
	/**
	 * This property can be used when presenting an object's slot. If this property is true the object that will be considered
	 * when replacing the properties in the link will be the parent object, that is, the object that contains the slot being
	 * presented.
	 * 
	 * <p>
	 ...
	 * specify the name of the view state destination that will be used. This property allows you to select the concrete
	 * destination in each context were this configuration is used.
	 * 
	 * @property
	 */
	...
	/**
	 * The text to appear as the link text. This is a simple alternative to the full presentation of the object.
	 * 
	 * @property
	 */
	...
	/**
	 * Instead of specifying thr {@link #setText(String) text} property you can specify a key, with this property, and a bundle
	 * with the {@link #setBundle(String) bundle}.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the sub layout that will be used for the body of the link, that is, the object will be presented using the layout
	 * specified and the result of that presentation will be the body of the link.
	 * 
	 * @property
	 */
	...
	/**
	 * The name of the schema to use in the presentation of the object for the body of the link.
	 * 
	 * @property
	 */
	...
	/**
	 * Chooses if the generated elements should be indented or not. This can be usefull when you want to introduce a separator but
