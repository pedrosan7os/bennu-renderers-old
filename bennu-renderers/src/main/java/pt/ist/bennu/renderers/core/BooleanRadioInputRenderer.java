...
/**
 * The <code>BooleanRadioInputRender</code> provides a way of doing the input of an Boolean value by using a list of radio
 * buttons. All the values of that Boolean are presented as a radio button and the use can choose one of the values.
 * 
 * <p>
 * Example:
 * <ul>
 ...
 * @author mrsp
 */
@Renderer(mode = RenderMode.INPUT, layout = "radio", type = Boolean.class)
public class BooleanRadioInputRenderer extends InputRenderer {

	/**
	 * this field is a format {@link FormatRenderer} that must evaluate to true of false, if true the slot will be rendered
	 * read-only, if false it won't
	 * 
	...
	/**
	 * This property is a formatted property (like {@link ConditionalFormatRenderer}) that is evaluated. If it is true, the slot
	 * will be considered read only, if false it won't
	 * 
	 * @author joantune - João Antunes
	 * @property
	 */
	...
	/**
	 * This property is a formatted property (like {@link ConditionalFormatRenderer}) that is evaluated. If it is false, the slot
	 * will be considered read only, if true it won't
	 * 
	 * @author joantune - João Antunes
	 * @property
	 */
	...
	/**
	 * Sets the bundle to be used when overring the boolean value presentation with labels.
	 * 
	 * @property
	 */
			...
			public HtmlComponent createComponent(Object object, Class type) {
				...
				if (getReadOnlyIf() != null || getReadOnlyIfNot() != null) {
					...
					if (useReadOnlyIfNotResult != null || useReadOnlyIfResult != null) {
						if (useReadOnlyIfNotResult != null && !useReadOnlyIfNotResult || useReadOnlyIfResult != null
								&& useReadOnlyIfResult) {
