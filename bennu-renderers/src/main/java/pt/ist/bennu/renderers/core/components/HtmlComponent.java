...
public abstract class HtmlComponent implements Serializable {
	...
	/**
	 * Sets the id of the component. If the given id is not a valid id then it will be transformed to obey SGML rules. As such
	 * {@link #getId()} may return a value that is not equal to the one given to this method.
	 * 
	 * @param id
	 *            the desired id
	 */
