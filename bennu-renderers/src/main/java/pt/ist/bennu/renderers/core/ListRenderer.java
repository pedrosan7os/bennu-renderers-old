...
/**
 * This renderer provides a basic presentation for a {@link java.util.List}. There is a direct translation from the list to an
 * html list. As such, each object in the list will be presented in a list item.
 * 
 * <p>
 * Example:
 * <ul>
 ...
 */
@Renderers({
		@Renderer(layout = "list-personFunctions", type = Collection.class, properties = {
				@RendererProperty(name = "eachLayout", value = "values"),
				@RendererProperty(name = "eachSchema", value = "site.functions.personFunction.person") }),
		@Renderer(layout = "list", type = Collection.class), @Renderer(type = java.util.List.class) })
public class ListRenderer extends OutputRenderer {
	...
	/**
	 * Selects if the generated list is a ordered list or a simple unordered list. By default the list is unordered.
	 * 
	 * @property
	 */
	...
	/**
	 * Allows you to choose the order in wich the elements will be presented.- See
	 * {@link pt.ist.bennu.renderers.core.utils.RenderUtils#sortCollectionWithCriteria(Collection, String)} for more details.
	 * 
	 * @property
	 */
	...
	class ListRendererLayout extends ListLayout {
		...
		protected void applyConditionalClasses(Object object, HtmlComponent component, CssStyler cssStyler) {
			Boolean useIf =
					cssStyler.getUseIf() != null
							&& (Boolean) RendererPropertyUtils.getProperty(object, cssStyler.getUseIf(), false);
			Boolean useIfNot =
					cssStyler.getUseIfNot() != null
							&& !(Boolean) RendererPropertyUtils.getProperty(object, cssStyler.getUseIfNot(), false);
			if (useIf || useIfNot) {
