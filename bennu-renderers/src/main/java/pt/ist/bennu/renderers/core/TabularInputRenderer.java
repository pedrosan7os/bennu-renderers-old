...
/**
 * This renderer allows to edit all objects of a collection at the same time. The presentation is very similar to the one of
 * {@link pt.ist.bennu.renderers.core.CollectionRenderer} but instead of presentig the slot's value in each cell, the slot's
 * editor is shown.
 * 
 * <p>
 * Example:
 ...
 * @author cfgi
 */
@Renderer(mode = RenderMode.INPUT, type = Collection.class, layout = "tabular-editable")
