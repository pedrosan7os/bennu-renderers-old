...
/**
 * This renderer allows you to present a collection of objects as a list but at the same time allows you to add control links to
 * each item like you can in {@link pt.ist.bennu.renderers.core.CollectionRenderer}. A table is used to accomplish this. Each
 * object will be presented in a row but the left column will contain the entire presentation of the object and further column
 * will contain the defined control links.
 * 
 * <p>
 * Example:
 * <table border="1">
 ...
 * @author cfgi
 */
@Renderer(layout = "tabular-list", type = Collection.class)
public class TabularListRenderer extends CollectionRenderer {
	...
	/**
	 * With this property you can choose the layout to be used in each object's presentation.
	 * 
	 * @property
	 */
	...
	/**
	 * Specifies the schema that will be used when presenting each sub object.
	 * 
	 * @property
	 */
