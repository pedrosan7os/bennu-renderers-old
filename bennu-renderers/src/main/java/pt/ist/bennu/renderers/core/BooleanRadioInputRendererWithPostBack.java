...
@Renderers({ @Renderer(mode = RenderMode.INPUT, layout = "radio-postback", type = Boolean.class),
		@Renderer(mode = RenderMode.INPUT, layout = "radio-postback", type = boolean.class) })
